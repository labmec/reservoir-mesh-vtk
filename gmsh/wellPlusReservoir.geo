// TODO: define an eccentricity parameter to shift the wellbore center
...
// Reservoir dimensions (must be greater than near-well region dimensions)
// Learn how to do a consistency check in gmsh
Lr = 30;
Hr = 10;
Wr = 20;
