...
if __name__ == "__main__":
    ...
    # points = [p6_we, p7_we, p8_we, p9_we, p10, p11, p12, p13]
    # for p in points:
    #     coords = gm.model.getValue(0, p, [])
    #     print(f'Point {p}: {coords}')
    ...
    # #print(f'The lens is 6 10 is: {p6 - p10}')
    ...
    #p_ = [p2_exd, p3_exd, p4_exd, p5_exd]
    #for id in p_:
    #    print(f'P: {id}')
...
#    gm.model.addPhysicalGroup(1 , [c2_wb, -l27_di, -l18_rez, l26_di], name = "teste")
...
#     # ===============================================================================
    ...
    for line in bump_lines:
        ...
        # gm.model.mesh.setTransfiniteCurve(line, l_div, coef = p_res)
        # transfinite_line_with_bump_field(line, l_div, p_well)
    ...
    gm.model.addPhysicalGroup(3, all_volumes, tag = 110, name = "volume_reservoir")
